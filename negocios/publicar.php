...
// Verifica se já foi enviado para aprovação
if ($negocio['status_vitrine'] === 'em_analise') {
    $_SESSION['erro'] = 'Este negócio já foi enviado para aprovação e está aguardando avaliação.';
    header("Location: /empreendedores/meus-negocios.php");
    exit;
}
