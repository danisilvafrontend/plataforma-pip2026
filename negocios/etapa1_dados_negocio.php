...
$pageTitle = "Etapa 1 - Dados Negócio";
  ...
  <form method="post" action="/negocios/processar_etapa1.php">
    ...
    <div class="form-section">
      ...
      <div class="row g-3" id="categoriaRadios">
        <?php
        $categorias = [
          ['value' => 'Ideação',       'img' => 'ideacao.png',      'sub' => 'Início da ideia',         'desc' => 'Dando os primeiros passos na formação da empresa, ainda sem formalização, mas com MVP sendo testado.'],
          ['value' => 'Operação',      'img' => 'operacao.png',     'sub' => 'Negócio em funcionamento', 'desc' => 'Empresa já formalizada, com faturamento e modelo de negócios validados.'],
          ['value' => 'Tração/Escala', 'img' => 'tracao.png',       'sub' => 'Crescimento e escala',     'desc' => 'Empresa já formalizada, atuando no mercado há mais de um ano, com ou sem entrada de investimento, e com escala de vendas em crescimento.'],
          ['value' => 'Dinamizador',   'img' => 'dinamizadores.png','sub' => 'Apoio e fomento',          'desc' => 'Organizações que fomentam o ecossistema de impacto: institutos, fundações, empresas, aceleradoras, incubadoras, academias, universidades, centros de pesquisa, laboratórios, consultorias, certificadoras, mentores, ONGs, movimentos sociais, entre outros.'],
        ];
