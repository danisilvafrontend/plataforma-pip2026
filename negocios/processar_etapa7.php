...
if ($visao_outro && !textoValido($visao_outro)) {
    $_SESSION['errors_etapa7'][] = "O campo 'Outro' em Visão Estratégica deve conter texto válido.";
}
if ($apoio_outro && !textoValido($apoio_outro)) {
    $_SESSION['errors_etapa7'][] = "O campo 'Outro' em Apoio Financeiro/Estratégico deve conter texto válido.";
}
if ($area_outro && !textoValido($area_outro)) {
    $_SESSION['errors_etapa7'][] = "O campo 'Outro' em Áreas a Fortalecer deve conter texto válido.";
}
