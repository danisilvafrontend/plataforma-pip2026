...
if (!$docs) {
    // Se não existe, redireciona para criar
    ...
    <form method="POST" action="processar_etapa9.php" enctype="multipart/form-data" class="mt-4">
        ...
        <div class="mb-4">
            ...
            <div class="mb-2 small text-success">
                ...
                <br><small class="text-muted">(Clique para visualizar)</small>
            </div>
            <input type="file"
            ...
            <div class="form-text small">
                ...
                ou envie novo PDF para substituir.
            </div>
        </div>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
            <a href="/negocios/editar_etapa8.php?id=<?= $negocio_id ?>" class="btn btn-secondary me-md-2">← Voltar</a>
