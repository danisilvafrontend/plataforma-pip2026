...
// Busca eixos temáticos do banco
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <h1 class="mb-4">Etapa 3: Eixo Temático</h1>
            ...
            <form action="/negocios/processar_etapa3.php" method="post">
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted d-block mb-2">Dado público, será exibido na vitrine</small>
                    <div id="eixosRadios" class="row">
                        <?php foreach ($eixos as $eixo): ?>
                        <div class="col-md-4 mb-4">
                            <label class="eixo-option card p-3 text-center h-100" style="cursor:pointer;">
                ...
                <div id="subareas-container" class="mb-4">
                    <!-- Aqui entram os checkboxes conforme o eixo selecionado -->
                </div>
            ...
            if (radio) {
                ...
                if (subareas[eixoId]) {
                    subareas[eixoId].forEach(sa => {
                        ...
                        div.innerHTML = `
                            <input class="form-check-input" type="checkbox" name="subareas[]" value="${sa.id}">
