...
if (empty($visao_estrategica)) {
    $_SESSION['errors_etapa8'][] = "Informe a visão estratégica do negócio.";
}
if (empty($sustentabilidade)) {
    $_SESSION['errors_etapa8'][] = "Informe a sustentabilidade financeira.";
}
if (empty($escala)) {
...
if (empty($areas)) {
    $_SESSION['errors_etapa8'][] = "Selecione pelo menos uma área que gostaria de fortalecer.";
}
if (empty($temas)) {
    $_SESSION['errors_etapa8'][] = "Selecione pelo menos um tema de aprendizado.";
}
