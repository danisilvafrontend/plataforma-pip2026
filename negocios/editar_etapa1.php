      ...
      <div class="emp-card mb-4">
        ...
        <div class="p-3">
          <div class="row g-3" id="categoriaRadios">
            <?php
            $categorias = [
              ['valor'=>'Ideação',       'img'=>'ideacao.png',       'sub'=>'Início da ideia',         'desc'=>'Dando os primeiros passos na formação da empresa, ainda sem formalização, mas com MVP sendo testado.'],
              ['valor'=>'Operação',      'img'=>'operacao.png',      'sub'=>'Negócio em funcionamento', 'desc'=>'Empresa já formalizada, com faturamento e modelo de negócios validados.'],
              ['valor'=>'Tração/Escala', 'img'=>'tracao.png',        'sub'=>'Crescimento e escala',    'desc'=>'Empresa já formalizada, atuando no mercado há mais de um ano, com ou sem entrada de investimento, e com escala de vendas em crescimento.'],
              ['valor'=>'Dinamizador',   'img'=>'dinamizadores.png', 'sub'=>'Apoio e fomento',         'desc'=>'Organizações que fomentam o ecossistema de impacto: institutos, fundações, empresas, aceleradoras, incubadoras, academias, universidades, centros de pesquisa, laboratórios, consultorias, certificadoras, mentores, ONGs, movimentos sociais, entre outros.'],
            ];
...
(function() {
  ...
  // ⚠️ Substitua pelo seu token real se necessário
