...
$pageTitle = 'Editar Etapa 5 — Apresentação do Negócio';
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="emp-card">
                    ...
                    <?php endif; ?>
                    <a href="/negocios/editar_etapa4.php?id=<?= (int)$negocio_id ?>" class="btn-emp-outline w-100 justify-content-center mb-2">
