        ...
        <div class="cadastro-card card border-0 shadow-sm overflow-hidden">
          ...
          <div class="card-body cadastro-card__body">
            ...
            <form action="/auth/processar_cadastro_sociedade.php" method="post" id="formCadastroComunidade" novalidate>
              ...
              <section class="step active" id="step1" data-step="0">
                ...
                <div class="cadastro-block">
                  ...
                  <div class="row g-2 mt-1">
                    <div class="col-md-6">
                      ...
                      <input type="email" name="email" id="emailInput" class="form-control" placeholder="voce@email.com" required>
                ...
                <div class="cadastro-actions">
                  ...
                  <button type="button" class="btn btn-primary btn-lg next" id="btnNext1">Continuar</button>
                </div>
              </section>
              ...
              <section class="step" id="step2" data-step="1">
                ...
                <div class="cadastro-block">
                  ...
                  <fieldset class="cadastro-fieldset">
                    <legend class="cadastro-legend">Quais temas mais despertam seu interesse?</legend>
                    <div class="row g-2">
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Meio Ambiente e Clima"><span><i class="bi bi-tree me-2"></i>Meio Ambiente e Clima</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Água e Oceanos"><span><i class="bi bi-droplet me-2"></i>Água e Oceanos</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Biodiversidade e Florestas"><span><i class="bi bi-flower1 me-2"></i>Biodiversidade e Florestas</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Economia Circular"><span><i class="bi bi-recycle me-2"></i>Economia Circular</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Energia Limpa"><span><i class="bi bi-lightning-charge me-2"></i>Energia Limpa</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Segurança Alimentar"><span><i class="bi bi-basket me-2"></i>Segurança Alimentar</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Saúde e Bem-Estar"><span><i class="bi bi-heart-pulse me-2"></i>Saúde e Bem-Estar</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Educação"><span><i class="bi bi-book me-2"></i>Educação</span></label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Igualdade de Gênero"><span><i class="bi bi-gender-ambiguous me-2"></i>Igualdade de Gênero</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Equidade Racial"><span><i class="bi bi-people me-2"></i>Equidade Racial</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Trabalho e Renda"><span><i class="bi bi-briefcase me-2"></i>Trabalho e Renda</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Cidades Sustentáveis"><span><i class="bi bi-buildings me-2"></i>Cidades Sustentáveis</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Inovação e Tecnologia"><span><i class="bi bi-cpu me-2"></i>Inovação e Tecnologia</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Inclusão Social"><span><i class="bi bi-people-fill me-2"></i>Inclusão Social</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Governança e Transparência"><span><i class="bi bi-shield-check me-2"></i>Governança e Transparência</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="interesses[]" value="Parcerias e Investimento Social"><span><i class="bi bi-person-hearts me-2"></i>Parcerias e Investimento Social</span></label>
                        </div>
                      </div>
                    </div>
                  </fieldset>
                ...
                <div class="cadastro-block">
                  <div class="cadastro-block__header">
                    ...
                    <p class="cadastro-block__desc mb-0">Quais Objetivos de Desenvolvimento Sustentável (ODS) você mais se identifica ou gostaria de acompanhar?</p>
                  </div>
                  <?php
                  $stmt = $pdo->query("
                    ...
                    <?php foreach ($todas_ods as $ods): ?>
                      <div class="col-12 col-md-6">
                        <label class="cadastro-ods-card">
                          <input class="form-check-input" type="checkbox" name="ods[]" value="<?= (int)$ods['id'] ?>">
                          <span class="cadastro-ods-card__content">
                            <?php if (!empty($ods['icone_url'])): ?>
                              <img src="<?= htmlspecialchars($ods['icone_url']) ?>" alt="ODS <?= (int)$ods['n_ods'] ?>" class="cadastro-ods-card__icon">
                            <?php endif; ?>
                            <span class="cadastro-ods-card__text"><strong>ODS <?= (int)$ods['numero_ods'] ?> - <?= htmlspecialchars($ods['nome']) ?></strong></span>
                          </span>
                        </label>
                      </div>
                    <?php endforeach; ?>
              ...
              <section class="step" id="step3" data-step="2">
                <div class="cadastro-step-header">
                  ...
                  <p class="cadastro-step-desc mb-0">Agora falta pouco. Conte quais tipos de negócios, setores e causas você prefere acompanhar.</p>
                </div>

                <div class="cadastro-block">
                  <div class="cadastro-block__header">
                    <h3 class="cadastro-block__title">Estágio de maturidade</h3>
                    <p class="cadastro-block__desc mb-0">Selecione os estágios dos negócios que mais fazem sentido para você acompanhar.</p>
                  </div>
                  <fieldset class="cadastro-fieldset">
                    <legend class="cadastro-legend">Você prefere acompanhar negócios em qual estágio de maturidade?</legend>
                    <div class="row g-2">
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="maturidade[]" value="Ideação"><span><i class="bi bi-lightbulb me-2"></i>Ideação (começando agora)</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="maturidade[]" value="Operação"><span><i class="bi bi-rocket me-2"></i>Operação (modelo sendo testado)</span></label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="maturidade[]" value="Tração / Escala"><span><i class="bi bi-graph-up me-2"></i>Tração / Escala (já operando e expandindo)</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="maturidade[]" value="Dinamizador"><span><i class="bi bi-globe me-2"></i>Dinamizador (impacto consolidado e ampliando alcance)</span></label>
                        </div>
                      </div>
                    </div>
                  </fieldset>
                ...
                <div class="cadastro-block">
                  <div class="cadastro-block__header">
                    ...
                    <p class="cadastro-block__desc mb-0">Escolha os setores que você gostaria de acompanhar mais de perto.</p>
                  </div>
                  <fieldset class="cadastro-fieldset">
                    <legend class="cadastro-legend">Há algum setor específico que você gostaria de acompanhar?</legend>
                    <div class="row g-2">
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Tecnologia"><span><i class="bi bi-cpu me-2"></i>Tecnologia</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Agronegócio sustentável"><span><i class="bi bi-tree me-2"></i>Agronegócio sustentável</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Saúde"><span><i class="bi bi-heart-pulse me-2"></i>Saúde</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Educação"><span><i class="bi bi-book me-2"></i>Educação</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Finanças de impacto"><span><i class="bi bi-cash-stack me-2"></i>Finanças de impacto</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Energia"><span><i class="bi bi-lightning-charge me-2"></i>Energia</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Moda sustentável"><span><i class="bi bi-bag me-2"></i>Moda sustentável</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Alimentação"><span><i class="bi bi-basket me-2"></i>Alimentação</span></label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Construção civil"><span><i class="bi bi-building me-2"></i>Construção civil</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Cultura"><span><i class="bi bi-music-note me-2"></i>Cultura</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="ESG corporativo"><span><i class="bi bi-bar-chart me-2"></i>ESG corporativo</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Startups"><span><i class="bi bi-lightbulb me-2"></i>Startups</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Negócios sociais"><span><i class="bi bi-people me-2"></i>Negócios sociais</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="Cooperativas"><span><i class="bi bi-diagram-3 me-2"></i>Cooperativas</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="setores[]" value="ONGs"><span><i class="bi bi-hand-thumbs-up me-2"></i>ONGs</span></label>
                        </div>
                      </div>
                    </div>
                  </fieldset>
                ...
                <div class="cadastro-block">
                  <div class="cadastro-block__header">
                    ...
                    <p class="cadastro-block__desc mb-0">Indique o tipo de impacto e de causa que você gostaria de ver mais na plataforma.</p>
                  </div>
                  <fieldset class="cadastro-fieldset">
                    <legend class="cadastro-legend">Que tipo de impacto você quer ver mais?</legend>
                    <div class="row g-2">
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Social"><span><i class="bi bi-people me-2"></i>Social</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Ambiental"><span><i class="bi bi-tree me-2"></i>Ambiental</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Social + Ambiental"><span><i class="bi bi-globe me-2"></i>Social + Ambiental</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Inovação tecnológica"><span><i class="bi bi-cpu me-2"></i>Inovação tecnológica</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Base comunitária"><span><i class="bi bi-house me-2"></i>Base comunitária</span></label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="cadastro-check-grid">
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Liderado por mulheres"><span><i class="bi bi-gender-female me-2"></i>Liderado por mulheres</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Liderado por jovens"><span><i class="bi bi-person me-2"></i>Liderado por jovens</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Impacto regional / local"><span><i class="bi bi-geo-alt me-2"></i>Impacto regional / local</span></label>
                          <label class="cadastro-check-card"><input class="form-check-input" type="checkbox" name="perfil_impacto[]" value="Impacto global"><span><i class="bi bi-globe2 me-2"></i>Impacto global</span></label>
                        </div>
                      </div>
                    </div>
                  </fieldset>
                ...
                <!-- QUESTÃO 1: Engajamento -->
                <div class="cadastro-block">
                  <div class="cadastro-block__header">
                    <h3 class="cadastro-block__title">Disponibilidade de engajamento</h3>
                    <p class="cadastro-block__desc mb-0">Quanto tempo você tem disponível para se engajar com negócios de impacto?</p>
                  </div>
                  <fieldset class="cadastro-fieldset">
                    <legend class="cadastro-legend">Quanto tempo você tem disponível para engajamento?</legend>
                    <div class="cadastro-radio-grid">
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="engajamento" value="Apenas online"><span><i class="bi bi-wifi me-2"></i>Apenas online</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="engajamento" value="Até 2 horas por mês"><span><i class="bi bi-clock me-2"></i>Até 2 horas por mês</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="engajamento" value="Até 5 horas por mês"><span><i class="bi bi-clock-history me-2"></i>Até 5 horas por mês</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="engajamento" value="Posso participar de eventos presenciais"><span><i class="bi bi-calendar-event me-2"></i>Posso participar de eventos presenciais</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="engajamento" value="Disponibilidade variável"><span><i class="bi bi-arrow-left-right me-2"></i>Disponibilidade variável</span></label>
                    </div>
                  </fieldset>
                </div>
                ...
                <div class="cadastro-block">
                  <div class="cadastro-block__header">
                    ...
                    <p class="cadastro-block__desc mb-0">Sua disposição para apoiar financeiramente negócios de impacto nos ajuda a conectar as pessoas certas.</p>
                  </div>
                  <fieldset class="cadastro-fieldset">
                    <legend class="cadastro-legend">Você estaria disposto(a) a apoiar financeiramente negócios?</legend>
                    <div class="cadastro-radio-grid">
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="apoio_financeiro" value="Sim – até R$ 100/mês"><span><i class="bi bi-currency-dollar me-2"></i>Sim – até R$ 100/mês</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="apoio_financeiro" value="Sim – até R$ 500/mês"><span><i class="bi bi-cash me-2"></i>Sim – até R$ 500/mês</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="apoio_financeiro" value="Sim – acima de R$ 500/mês"><span><i class="bi bi-cash-stack me-2"></i>Sim – acima de R$ 500/mês</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="apoio_financeiro" value="Apenas compras pontuais"><span><i class="bi bi-bag-check me-2"></i>Apenas compras pontuais</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="apoio_financeiro" value="Não"><span><i class="bi bi-x-circle me-2"></i>Não</span></label>
                    </div>
                  </fieldset>
                </div>
                ...
                <div class="cadastro-block">
                  <div class="cadastro-block__header">
                    ...
                    <p class="cadastro-block__desc mb-0">Escolha o tipo de alcance das causas que você prefere apoiar.</p>
                  </div>
                  <fieldset class="cadastro-fieldset">
                    <legend class="cadastro-legend">Você prefere apoiar causas:</legend>
                    <div class="cadastro-radio-grid">
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="alcance" value="Da minha cidade/região"><span><i class="bi bi-geo-alt me-2"></i>Da minha cidade/região</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="alcance" value="Do meu estado"><span><i class="bi bi-map me-2"></i>Do meu estado</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="alcance" value="Nacionais"><span><i class="bi bi-flag me-2"></i>Nacionais</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="alcance" value="Globais"><span><i class="bi bi-globe me-2"></i>Globais</span></label>
                      <label class="cadastro-radio-card"><input class="form-check-input" type="radio" name="alcance" value="Não tenho preferência geográfica"><span><i class="bi bi-compass me-2"></i>Não tenho preferência geográfica</span></label>
                    </div>
                  </fieldset>
                </div>
                ...
                <div class="cadastro-submit-box">
                  <div>
                    ...
                    <p class="cadastro-submit-box__text mb-0">Revise suas escolhas, volte se precisar ajustar alguma informação e finalize seu cadastro.</p>
                  </div>
                  <div class="cadastro-block mt-3">
                    <div class="form-check form-check-soft">
                      <input class="form-check-input" type="checkbox" name="aceite_termos" id="checkAceiteTermos" value="1" required>
                      ...
                      <div class="invalid-feedback">Você precisa aceitar os termos para concluir o cadastro.</div>
                    </div>
                  </div>
            ...
            <div class="text-center mt-4">
              <a href="/login.php" class="cadastro-login-link text-decoration-none">Já tem conta? Faça login</a>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const VERIFICAR_CPF  = './app/api/verificar_cpf.php';
  ...
  // estado de disponibilidade do CPF (null = ainda checando, true = ok, false = duplicado)
  let cpfDisponivel = null;
  ...
  // ── Controle do botão Continuar (Step 1) ────────────────────────────────
  function atualizarBotaoNext1() {
    if (!btnNext1) return;
    const bloqueado = cpfDisponivel === false || cpfDisponivel === null && onlyDigits(cpfInput ? cpfInput.value : '').length === 11;
    // só bloqueia se CPF foi totalmente digitado e retornou indisponível
    if (cpfDisponivel === false) {
      btnNext1.disabled = true;
      btnNext1.title = 'Resolva o problema com o CPF antes de continuar.';
    } else {
  ...
  // ── Estados da API Receita Federal ───────────────────────────────────────
  ...
  function setCpfDuplicado(mensagem) {
    cpfDisponivel = false;
    if (cpfInput)  { cpfInput.classList.remove('is-valid'); cpfInput.classList.add('is-invalid'); cpfInput.setCustomValidity(mensagem); }
    if (cpfBadge)  { cpfBadge.innerHTML = '<i class="bi bi-x-circle-fill text-danger"></i>'; cpfBadge.classList.remove('d-none'); }
    if (cpfHelp)   cpfHelp.innerHTML = '<span class="text-danger"><i class="bi bi-exclamation-triangle-fill me-1"></i>' + mensagem + ' <a href="/login.php">Faça login</a>.</span>';
    atualizarBotaoNext1();
  }
  ...
  function setApiSuccess(nomeCompleto) {
    ...
    // Após obter o nome, verifica duplicidade
    verificarCPF(onlyDigits(cpfInput ? cpfInput.value : ''));
  }
  ...
  // ── Verifica duplicidade do CPF no banco ─────────────────────────────────
  function verificarCPF(digits) {
    if (cpfHelp) cpfHelp.innerHTML = '<span class="text-muted"><span class="spinner-border spinner-border-sm me-1"></span>Verificando disponibilidade…</span>';
    fetch(VERIFICAR_CPF + '?cpf=' + digits)
      .then(function (res) { return res.json(); })
      .then(function (data) {
        if (data.disponivel === false) {
          setCpfDuplicado(data.mensagem || 'CPF já cadastrado na plataforma.');
        } else {
          cpfDisponivel = true;
          if (cpfInput)  { cpfInput.classList.remove('is-invalid'); cpfInput.classList.add('is-valid'); cpfInput.setCustomValidity(''); }
          if (cpfBadge)  { cpfBadge.innerHTML = '<i class="bi bi-check-circle-fill text-success"></i>'; cpfBadge.classList.remove('d-none'); }
          if (cpfHelp)   cpfHelp.innerHTML = '<span class="text-success">CPF válido e disponível ✓</span>';
          atualizarBotaoNext1();
        }
      })
      .catch(function () {
        // Se a verificação falhar, não bloqueia o fluxo — o servidor fará a validação final
        cpfDisponivel = true;
    ...
    cpfInput.addEventListener('input', function (e) {
      ...
      if (d.length === 11) {
        if (!validarCPF(d)) {
          ...
          cpfInput.classList.remove('is-invalid'); cpfInput.setCustomValidity('');
          clearApiFields();
  ...
  // ── Listener E-mail: verifica duplicidade ao sair do campo ───────────────
  if (emailInput) {
    emailInput.addEventListener('blur', function () {
      ...
      emailDebounce = setTimeout(function () {
        const cpfDigits = onlyDigits(cpfInput ? cpfInput.value : '');
        const url = VERIFICAR_CPF + '?cpf=' + cpfDigits + '&email=' + encodeURIComponent(email);
        fetch(url)
          .then(function (res) { return res.json(); })
          .then(function (data) {
            if (data.disponivel === false && data.mensagem && data.mensagem.toLowerCase().includes('e-mail')) {
              emailInput.classList.add('is-invalid');
              emailInput.setCustomValidity(data.mensagem);
              if (emailHelp) emailHelp.innerHTML = '<span class="text-danger"><i class="bi bi-exclamation-triangle-fill me-1"></i>' + data.mensagem + ' <a href="/login.php">Faça login</a>.</span>';
            } else {
  ...
  function validarInputCPF() {
    ...
    if (cpfDisponivel === false) { cpfInput.setCustomValidity('CPF já cadastrado na plataforma.'); return false; }
  ...
  nextButtons.forEach(function (btn) {
    btn.addEventListener('click', function () {
      // Se é o botão do step 1 e CPF ainda está sendo verificado, bloqueia
      if (currentStep === 0 && cpfDisponivel === false) {
        if (cpfHelp) cpfHelp.scrollIntoView({ behavior: 'smooth', block: 'center' });
        return;
      }
